...
import com.finwin.doorstep.digicob.home.jlg.split_transaction.pojo.Sector
import com.finwin.doorstep.digicob.home.jlg.split_transaction.pojo.SubSector
...
class JlgLoanGeneralDetailsViewModel(application: Application) : AndroidViewModel(application), Observable {
    ...
    fun setSelectedSubSector(selectedSubSector: Int) {
        this.selectedSubSector = selectedSector
