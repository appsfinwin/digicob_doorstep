...
import com.finwin.doorstep.digicob.databinding.JlgGroupCreationFragmentBinding
import com.finwin.doorstep.digicob.home.customer_creation.action.CustomerCretaionAction
import com.finwin.doorstep.digicob.home.jlg.jlg_group_creation.adapter.MemberAdapter
...
import com.finwin.doorstep.digicob.home.jlg.search_member.SearchMemberActivity
    ...
    private fun setObservable(memberAdapter: MemberAdapter) {
        ...
        memberAdapter.mAction.observe(viewLifecycleOwner, Observer {
            when(it.action)
            {
                ...
                {
                    memberAdapter.removeMember(it.selectedMember)
                    viewModel.removeMember(it.selectedMember)
                    memberAdapter.notifyDataSetChanged()
                }
