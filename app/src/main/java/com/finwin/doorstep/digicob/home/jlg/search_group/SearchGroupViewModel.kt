package com.finwin.doorstep.digicob.home.jlg.search_group
...
import com.finwin.doorstep.digicob.home.jlg.jlg_center_creation.pojo.CenterData
import com.finwin.doorstep.digicob.home.jlg.search_group.action.SearchGroupAction
...
class SearchGroupViewModel : ViewModel(), Observable {
    ...
    var centerListData = ObservableArrayList<com.finwin.doorstep.digicob.home.jlg.search_group.pojo.CenterData>()
    ...
    init {
        ...
        centerListData.add(com.finwin.doorstep.digicob.home.jlg.search_group.pojo.CenterData("","","","","",""))
    ...
    fun setCenterData(data: List<com.finwin.doorstep.digicob.home.jlg.search_group.pojo.CenterData>) {
