...
import com.finwin.doorstep.digicob.home.jlg.jlg_loan_creation.jlg_loan_details.pojo.DD
import com.finwin.doorstep.digicob.home.jlg.jlg_loan_creation.jlg_loan_details.pojo.LoanPeriodData
import com.finwin.doorstep.digicob.home.jlg.split_transaction.pojo.CollectionStaff
import com.finwin.doorstep.digicob.home.jlg.split_transaction.pojo.Mode
...
class JlgLoanDetailsViewModel(private val repository: JlgLoanDetailsRepository) : ViewModel(),
    Observable {
...
class LoanDetailsViewmodelFactory(private val repository: JlgLoanDetailsRepository) :
    ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(JlgLoanDetailsViewModel::class.java)) {
            @Suppress("UNCHECKED_CAST")
            return JlgLoanDetailsViewModel(repository) as T
        }
