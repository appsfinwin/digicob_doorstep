...
import com.finwin.doorstep.digicob.home.jlg.split_transaction.SplitTransactionRepository
import com.finwin.doorstep.digicob.home.jlg.split_transaction.pojo.Charges
...
class SplitClosingViewModel(application: Application) : AndroidViewModel(application) {
    ...
    var sharedPreferences: SharedPreferences = application.getSharedPreferences(com.finwin.doorstep.digicob.utils.Constants.PREFERENCE_NAME,
...
//    var branchCode = ObservableField("")
    ...
    fun splitTransaction() {
        ...
        val jsonParams: MutableMap<String?, Any?> = HashMap()
        jsonParams["Ln_Type"] = ""
        jsonParams["Brcode"] = sharedPreferences.getString(com.finwin.doorstep.digicob.utils.Constants.BRANCH_ID,"")
        jsonParams["Tran_no"] = ""
        ...
        jsonParams["MakerId"] = sharedPreferences.getString(com.finwin.doorstep.digicob.utils.Constants.AGENT_ID,"")
