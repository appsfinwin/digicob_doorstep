...
import com.finwin.doorstep.digicob.databinding.ClosingGeneralDetailsFragmentBinding
        ...
        viewModel.mAction.observe(viewLifecycleOwner, Observer {
            ...
            when (it.action) {
                ...
                JlgAction.CLICK_NEXT_FROM_GENERAL_DETAILS->
                {
                    ...
                    (activity as SplitClosingActivity?)?.viewModel?.schemeCode?.set(viewModel.scheme.get())
